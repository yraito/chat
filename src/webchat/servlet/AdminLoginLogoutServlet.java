...
public class AdminLoginLogoutServlet extends HttpServlet{
	...
	private static final String ADMIN_AUTH_ERROR = "auth_error";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		} else if (relPath.startsWith("/processlogin")) {
			processLogin(req, resp);
		} else if (relPath.startsWith("/processlogout")) {
	...
	protected void processLogin(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (usrRecord == null) {
			...
			req.setAttribute(ADMIN_AUTH_ERROR, "Invalid credentials");
			req.getRequestDispatcher("login.jsp").forward(req, resp);
		}
